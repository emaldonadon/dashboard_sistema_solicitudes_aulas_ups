...
import { ActivarAula } from "./ActivarAula";

export const ListaAulasInactivas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        let ref = db
            ...
            .doc(params.sede)
            .collection('campus')
            .doc(params.campus).collection("edificios").doc(params.edificio).collection('aulas').where('estado', '==', 1);
    ...
    const columns = [
        { field: 'piso', headerName: 'PISO ', width: 70 },
        { field: 'aula', headerName: 'AULA', width: 165 },
        { field: 'motivo_inactivacion', headerName: 'MOTIVO INHABILITACION', width: 350 },
        {
        ...
        {
            field: '1', headerName: 'HABILITAR', width: 120,
            renderCell: (params) => {
                return <ActivarAula props={params.row} />
            }
        },
        {
