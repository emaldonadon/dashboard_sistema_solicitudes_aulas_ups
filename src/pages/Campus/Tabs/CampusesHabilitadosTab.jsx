...
import { InactivarCampusButton } from "../ButtonsActions/InactivarCampusButton";
import { DeleteCampus } from "../DeleteCampus";

export const CampusesHabilitadosTab = ({ sede }) => {
    ...
    const DataEspaciosHabilitados = async () => {
        ...
        let ref = await db.collection("sedes").doc(sede).collection('campus').where('estado', '==', 0);
    ...
    const columns = [
        ...
        { field: 'direccion', headerName: 'DIRECCION', width: 400 },
        {
            ...
            renderCell: (params) => {
                return <InactivarCampusButton props={params.row} />
            }
        },
        {
