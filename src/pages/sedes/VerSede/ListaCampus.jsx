...
import { InactivarCampus } from "./InactivarCampus";
...
export const ListaCampus = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        let ref = db.collection("sedes").doc(params.sede).collection('campus').where('estado', '==', 0);
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                return <InactivarCampus props={params.row} />
            }
        },
        {
