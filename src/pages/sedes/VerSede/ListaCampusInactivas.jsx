...
import { ActivarCampus } from "./ActivarCampus";

export const ListaCampusInactivas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        let ref = db.collection("sedes").doc(params.sede).collection('campus').where('estado', '==', 1);
    ...
    const columns = [
        ...
        },
        {
            ...
            renderCell: (params) => {
              return <ActivarCampus props={params.row} />
            }
        },
        {
