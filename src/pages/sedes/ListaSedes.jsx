...
export const ListaSedes = () => {
    ...
    const columns = [
        {
            field: '1', headerName: 'SEDES', width: 165,
            renderCell: (params) => {
                return <RouterLink style={{ textDecoration: 'none' }} to={`/sedes/ver/${params.row.sede}`}>{params.row.sede}</RouterLink>
            }
        },
