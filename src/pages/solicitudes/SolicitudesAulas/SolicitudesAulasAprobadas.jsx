...
export const SolicitudesAulasAprobadas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        console.log('auth.currentUser.cargo', auth.currentUser.cargo)

        if (auth.currentUser.cargo === 'ADMINISTRADOR') {
            if (endDate && startDate) {
                let ref = db.collection("solicitudes_aulas").where('estado', '==', 1);
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `Solicitudes_Aprobadas ${date1}.xlsx`)
    }
        ...
        <>
            ...
            <Box pl={1}>
                <p style={{ marginBottom: "0px", marginTop: "0px", fontSize: "14px" }}>
                    SOLICITUDES APROBADAS (<strong>{data && data.length}</strong>)
                </p>
