...
export const SolicitudesAulasCompletadas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        if (auth.currentUser.rol === 'ADMINISTRADOR') {
            if (endDate && startDate) {
                let ref = db.collection("solicitudes_aulas").where('estado', '==', 7);
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `Solicitudes_Completadas ${date1}.xlsx`)
    }
        ...
        <>
            ...
            <Box pl={1}>
                <p style={{ marginBottom: "0px", marginTop: "0px", fontSize: "14px" }}>
                    SOLICITUDES CANCELADAS (<strong>{data && data.length}</strong>)
                </p>
