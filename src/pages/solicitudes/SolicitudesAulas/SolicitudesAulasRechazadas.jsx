...
export const SolicitudesAulasRechazadas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        if (auth.currentUser.rol === 'ADMINISTRADOR') {
            if (endDate && startDate) {
                let ref = db.collection("solicitudes_aulas").where('estado', '==', 4);
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `Solicitudes_Rechazadas ${date1}.xlsx`)
    }
        ...
        <>
            ...
            <Box pl={1}>
                <p style={{ marginBottom: "0px", marginTop: "0px", fontSize: "14px" }}>
                    SOLICITUDES RECHAZADAS (<strong>{data && data.length}</strong>)
                </p>
