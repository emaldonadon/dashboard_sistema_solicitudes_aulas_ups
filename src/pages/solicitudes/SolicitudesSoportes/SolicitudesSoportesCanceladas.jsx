...
export const SolicitudesSoportesCanceladas = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        if (auth.currentUser.cargo === 'ADMINISTRADOR') {
            let ref = db.collection("solicitudes_soporte").where('estado', '==', 3);
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `Solicitudes_Soporte_Tecnico_Canceladas ${date1}.xlsx`)
    }
