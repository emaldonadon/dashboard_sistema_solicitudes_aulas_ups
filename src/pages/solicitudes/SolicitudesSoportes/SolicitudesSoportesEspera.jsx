...
export const SolicitudesSoportesEspera = () => {
    ...
    const LoadData = (startAfterDoc, persistMessages = []) => {
        ...
        if (auth.currentUser.cargo === 'ADMINISTRADOR') {
            let ref = db.collection("solicitudes_soporte").where('estado', '==', 0);
    ...
    const handleExport = () => {
        ...
        XLSX.writeFile(wb, `Solicitudes_Soporte_Tecnico_En_Espera ${date1}.xlsx`)
    }
