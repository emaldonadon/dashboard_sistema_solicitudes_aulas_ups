...
import { EspaciosHabilitadosTab } from "./Tabs.jsx/EspaciosHabilitadosTab";
import { EspaciosInhabilitadosTab } from "./Tabs.jsx/EspaciosInhabilitadosTab";

export const ListaEspaciosFisicos = () => {
    ...
    return (
        <>
            ...
            <Box px={2}>
                <p style={{ marginBottom: "8px", marginTop: "8px" }}><strong>LISTA DE ESPACIOS FISICOS</strong></p>
            </Box>
            ...
            <TabPanel value={tab} index={0}>
                ...
                <EspaciosHabilitadosTab sede={sede} campus={campus} />

            </TabPanel>

            <TabPanel value={tab} index={1}>
                <EspaciosInhabilitadosTab sede={sede} campus={campus} />
            </TabPanel>
