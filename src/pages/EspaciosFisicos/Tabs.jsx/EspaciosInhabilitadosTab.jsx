...
import { ActivarEspacioButton } from "../ButtonsActions/ActivarEspacioButton";
import { DeleteEspacioFisico } from "../ButtonsActions/DeleteEspacioFisico";

export const EspaciosInhabilitadosTab = ({ sede, campus }) => {
    ...
    const DataEspaciosHabilitados = async () => {
        ...
        let ref = await db.collection("sedes").doc(sede).collection('campus').doc(campus).collection('espacios_fisicos').where('estado', '==', 1);
    ...
    const columns = [
        ...
        {
            field: '2', headerName: 'HABILITAR', width: 120,
            renderCell: (params) => {
                return <ActivarEspacioButton props={params.row} />
            }
        },
        {
